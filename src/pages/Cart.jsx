...
<path d="M11.6666 9.16667V14.1667" stroke="#B6B6B6" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
  ...
  <div className="content__items">
    ...
    {addedPizza.map((obj) => (
      <CartItem  key={`${items[obj.id].totalPrice} `} name={obj.name} type={obj.type} size={obj.size} totalPrice={items[obj.id].totalPrice} totalCount={items[obj.id].items.length} onRemove={onRemoveItem} id={obj.id} onMinus={onMinusItem} onPlus={onPlusItem}/>
    ) )
    }
...
<h2>Cart is empty 😕</h2>
<p>most likely you haven't ordered pizza yet.<br />
